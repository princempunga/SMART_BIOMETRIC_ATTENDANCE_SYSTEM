...
<div class="space-y-8">
    ...
    <div class="bg-[#0F172A] rounded-2xl p-8 text-white flex items-center justify-between shadow-xl shadow-slate-900/40 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <p class="text-blue-400 text-[10px] font-bold uppercase tracking-[0.3em] mb-3">Academic Overview</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5">
        <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-purple-500">
            ...
            <p class="text-purple-500 text-xs font-bold mt-2">In your faculty</p>
        </div>
        <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-blue-500">
            ...
            <p class="text-blue-500 text-xs font-bold mt-2">Teaching staff</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div class="lg:col-span-3 bg-white rounded-xl shadow-sm overflow-hidden border border-slate-100">
            <div class="p-6 border-b border-slate-100 flex justify-between items-center">
                ...
                <a href="{{ route('dean.attendance') }}" class="text-xs font-bold text-purple-600 hover:underline uppercase">View All</a>
            </div>
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-slate-100">
            ...
            <div class="p-4 space-y-3">
                ...
                <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl hover:bg-purple-50 transition-colors group">
                    ...
                    <span class="text-xs font-bold text-purple-600 bg-purple-50 px-2 py-1 rounded-lg">{{ $dept->students_count }}</span>
                </div>
                @empty
            ...
            <div class="p-4 border-t border-slate-100 space-y-2">
                <a href="{{ route('dean.students') }}" class="flex items-center gap-3 p-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition-colors font-bold text-sm">
